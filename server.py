...
from colorama import Fore, Style  # To add colors to print statements
...
def server_handshake(conn):
    ...
    print("\n" + "="*50 + "\n")  # Section separator
    server_random = 'server_random_value'
    server_hello = f"ServerHello: version=TLS 1.2, random={server_random}"
    print(f"{Fore.BLUE}Server: Sending ServerHello message with random value {server_random}{Style.RESET_ALL}")
